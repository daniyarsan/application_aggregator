...
class Applicant
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="PersonalInformation", mappedBy="applicant", cascade={"remove", "persist"})
     *
     */
    ...
    /**
     * @ORM\OneToOne(targetEntity="Document", mappedBy="applicant",  cascade={"persist","remove"})
     *
     */
    protected $document;
