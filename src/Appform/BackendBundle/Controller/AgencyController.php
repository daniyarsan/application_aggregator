...
use Appform\BackendBundle\Form\AgencyType;
...
class AgencyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppformBackendBundle:Agency')->findAll();
     ...
     * @Method("POST")
     * @Template("AppformBackendBundle:Agency:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppformBackendBundle:Agency')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppformBackendBundle:Agency:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('agency', array('id' => $id)));
        }
