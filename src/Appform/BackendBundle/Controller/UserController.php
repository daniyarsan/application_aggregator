...
class UserController extends Controller {
	...
	public function indexAction( Request $request ) {
		...
		return $this->render( 'AppformBackendBundle:User:users.html.twig', array(
	...
	public function userEditAction( $id, Request $request ) {
		...
		return $this->render( '@AppformBackend/User/editUser.html.twig', array(
	...
	/**
	 * @Route("/users", name="user_download")
	 */
	...
	/**
	 * @Route("/users", name="user_prepare_excel")
	 */
	...
	/**
	 * @Route("/users", name="user_send_message")
	 */
	...
	/**
	 * @Route("/users", name="user_regenerate")
	 */
	...
	/**
	 * @Route("/users", name="user_send_report")
	 */
	...
	/**
	 * @Route("/users", name="user_get_registered")
	 */
	...
	/**
	 * @Route("/users", name="user_save_filter")
	 */
